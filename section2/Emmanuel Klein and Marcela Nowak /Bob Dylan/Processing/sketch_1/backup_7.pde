...
//float highlightTextSize=20;
//int largeTextSize=30;

//int albumNumber=1;//start album 1 because unalbumed songs are 0
//int lastAlbumNumber=10;//last album if num is to big will get all albums (37 albums total)
...
//int dim_album_w=4000;
//int dim_album_h=2000;
...
//    //int textSize=largeTextSize;
//    this.displayGraphic.textSize(largeTextSize);
...
//    this.displayGraphic.text(this.name, shiftAlbumTitle, height/2-largeTextSize/2);
//    this.displayGraphic.textAlign(CENTER, CENTER);
    
//    this.displayGraphic.textSize(largeTextSize*.7);
//    this.displayGraphic.text(this.year, shiftAlbumTitle/2, height/2+largeTextSize/2);
