...
//int dim_album_w=15000;
//int dim_album_h=10000;
////int dimention_year_h=100;

//void setup() {
//  //size(5000, 5000);
//  size(15000, 10000, PDF, "filename.pdf");
...
//  }
//    albums.get(songNumber).drawSongs();
//}
...
//      //}
//      songs.get(i).addText(this.displayGraphic, smallTextSize, highlightTextSize);
//    }
//    image(this.displayGraphic,xCenter,0);
...
//    addText(_pgraphic, _textSize, _textSize);
//  }

//  void addText(PGraphics _pgraphic, float _textSizeMain, float _textSizeHighlight) {
    
    
//    _pgraphic.beginDraw();
//    _pgraphic.pushMatrix();
//    _pgraphic.translate(0, _pgraphic.height/2); //_pgraphic.translate(_pgraphic.width/2, _pgraphic.height/2);
...
//     if(pos[i].indexOf("jj") == 0 && pos[i+1].indexOf("nn") == 0){
//        _pgraphic.translate(0,-4);//shift if up
...
//        _pgraphic.translate(0,4);//shift down
//      }else{
